      ...
      <div class="menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
          <ul class="list-unstyled navbar__list">
            <li>
              <router-link to="/management/mainPage">
                <i class="fas fa-tachometer-alt"></i>Main</router-link>
            </li>
            <li>
              <router-link to="/management/account">
                <i class="fas fa-chart-bar"></i>Account</router-link>
            </li>
            <li>
              <router-link to="/management/order">
            ...
            <div class="header-button">
              ...
              <div class="account-wrap">
                <div class="account-item clearfix js-item-menu">
                  <div class="image">
                    <img src="../../static/images/icon/avatar-01.jpg" alt="admin" />
                  </div>
                  <div class="content">
